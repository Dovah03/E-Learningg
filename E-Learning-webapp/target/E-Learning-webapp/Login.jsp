	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" name="form" action="<%=request.getContextPath()%>/LoginServlet" method="post"> 
				...
				<div class="login100-more" style="background-image: url('images/iStock-872232248.jpg');">
				</div>
			</div>
		</div>
	</div>
