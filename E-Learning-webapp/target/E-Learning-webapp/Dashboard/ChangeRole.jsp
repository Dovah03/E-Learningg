  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Changer de Role</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>  Veuillez choisir le role</h4>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li><a href="<%=Path%>/ChangeRoleServlet?id=<%=ID%>&Role=Admin">Changer en Admin</a></li>
                  <li><a href="<%=Path%>/ChangeRoleServlet?id=<%=ID%>&Role=Enseignant">Changer en Enseignant</a></li>
                  <li><a href="<%=Path%>/ChangeRoleServlet?id=<%=ID%>&Role=Etudiant">Changer en Etudiant</a></li>
                </ul>
              </div>
              <a class="btn btn-theme04" type="button" href="<%=Path%>/Dashboard/AdminTables.jsp">Cancel</a>
                    </div>
                  </div>
                </form>
              </div>
