...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <% UserBean currentUser = (UserBean)session.getAttribute("user"); 
        ...
        String namef = currentUser.getFullName();	%>
  <%
    ...
    <!--main content start-->
     <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Formations que vous enseignez:</h3>
        <p><i> (si aucune formation n'est disponible veuillez contacter votre administrateur pour ajouter une formation de votre choix:)</i></p>
        <div class="row mt">
        <div class="col-lg-12">
          <div class="row">
          <%while(rs.next()){
              if (namef.equals(rs.getString("nom_formateur"))) { 	%>
          <div class="col-lg-4 col-md-4 col-sm-4 mb">
            <div class="white-panel pn">
                  <div class="white-header">
                    <h5>Formation</h5>
                  </div>
                  <p><a href="<%=Path%>/Dashboard/tfDetails.jsp?id=<%=rs.getInt("id_formation")%>"><img src="<%=Path%>/Dashboard/img/thumbnailformation.jpg" class="img-circle" width="100"></a></p>
                  <h5><b><%=rs.getString("titre_formation")%></b></h5>
                  <div class="row">
                    <div class="col-md-6">
