    ...
    <!--sidebar start-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="<%=Path%>/Dashboard/Profile3.jsp"><img src="<%=ProfileUser.getUrlPhoto() %>" class="img-circle" width="80"></a></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="<%=Path%>/Dashboard/StudentView.jsp">Acceuil</a></li>
