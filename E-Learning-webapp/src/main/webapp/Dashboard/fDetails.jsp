    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="<%=Path%>/Dashboard/Profile3.jsp"><img src="<%=currentUser.getUrlPhoto() %>" class="img-circle" width="80"></a></p>
          <h5 class="centered"><%=currentUser.getFullName() %></h5>
          <li class="mt">
            <a href="<%=Path%>/Dashboard/StudentView.jsp">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="<%=Path%>/Dashboard/StudentView.jsp">Acceuil</a></li>
              <li><a href="<%=Path%>/LogoutServlet" onclick="return confirm('Etes-vous sûr de vouloir vous déconnecter?')">Changer de Compte</a></li>
              <li><a href="<%=Path%>/Dashboard/Profile3.jsp">Consulter Profile</a></li>
            </ul>
             <li class="sub-menu">
            <a href="javascript:;">
            ...
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body">
                ...
                <div class="pull-right">
                  <h2><a type="button" href="/E-Learning-webapp/index.html" class="btn btn-primary btn-lg">Consulter la sceance</a></h2>
                </div>
                <!-- /pull-right -->
